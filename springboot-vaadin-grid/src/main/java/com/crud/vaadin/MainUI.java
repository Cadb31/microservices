...
public class MainUI extends UI {
    ...
    private Grid gridList = new Grid();
    ...
    protected void init(VaadinRequest request) {    	
    	...
    	gridList.addColumn("Id");
    	gridList.addColumn("Nombre");
    	gridList.addColumn("Email");
    	gridList.addColumn("Edad");
    	gridList.addColumn("Telefono");

    	List<Person> personas = repo.findAll();
    	for (Person p: personas) {    		
			gridList.addRow(String.valueOf(p.getId()), p.getName(), p.getEmail(), String.valueOf(p.getEdad()), String.valueOf(p.getPhoneNumber()));
		}
